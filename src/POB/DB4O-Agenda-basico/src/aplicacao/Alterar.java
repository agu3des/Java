...
public class Alterar {
	...
	public Alterar(){
		...
		if(resultados.size()>0) {
			...
			p.adicionar(new Telefone("99999999")); //adicionar novo telefone
			...
			//manager.delete(t);	//para apagar orfao no banco

			manager.commit();
			System.out.println("alterou joao para joana / alterou seus telefones");
		}
		else
