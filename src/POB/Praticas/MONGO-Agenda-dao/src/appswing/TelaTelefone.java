...
public class TelaTelefone {
	...
	private void initialize() {
		...
		button = new JButton("Buscar por numero");
		...
		button.setBounds(166, 10, 150, 23);
		...
		label_3 = new JLabel("Digitos:");
		label_3.setBounds(26, 15, 46, 14);
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Fachada.alterarTelefone(numero1, numero2);
	...
	public void listagem () {
		try{
			...
			frame.setTitle("Telefone   "+ LocalDateTime.now().format(DateTimeFormatter.ofPattern("dd-MM-yyyy hh:mm:ss")));
		}
		catch(Exception erro){
			label.setText(erro.getMessage());
		}
