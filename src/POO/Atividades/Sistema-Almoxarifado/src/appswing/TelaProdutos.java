...
public class TelaProdutos {
	...
	private void initialize() {
		frame = new JDialog();	//classe que permite
		frame.setModal(true);	//travar a janela na tela
		...
		table = new JTable() {	//impedir edicao das celulas
		...
		table.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) { //clicar na linha da tabela
				label.setText("");
