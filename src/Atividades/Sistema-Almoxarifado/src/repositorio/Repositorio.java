...
public class Repositorio {
	...
	public void	salvarObjetos()  {
		...
		try	{
			...
			throw new RuntimeException("problema na gravação do arquivo  prateleiras "+e.getMessage());
		}
		...
		try	{
			...
			throw new RuntimeException("problema na gravação do arquivo  produtos "+e.getMessage());
		}
