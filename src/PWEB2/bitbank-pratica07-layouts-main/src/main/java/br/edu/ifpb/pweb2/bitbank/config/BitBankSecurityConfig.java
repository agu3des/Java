...
public class BitBankSecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        ...
        UserDetails sagan = User.withUsername("sagan").password(passwordEncoder().encode("cosmos")).roles("CLIENTE")
                .build();
        UserDetails turing = User.withUsername("turing").password(passwordEncoder().encode("enignma")).roles("CLIENTE")
                .build();
        UserDetails ada = User.withUsername("ada").password(passwordEncoder().encode("firstcoder")).roles("CLIENTE")
                .build();
